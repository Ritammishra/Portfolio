    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                ...
                <p className='py-6'>I'm always open to new opportunities and collaborations. Let's connect and discuss how I can bring your ideas to life!</p>
            </div>
            <div className='flex justify-center item-center'>
                <form action="https://getform.io/f/ab46646e-8200-4ab0-ab6e-09564b7dc96f" method='POST' className='flex flex-col w-full md:w-1/2'>
